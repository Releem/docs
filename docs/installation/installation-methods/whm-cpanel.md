---
id: whm-cpanel
slug: /installation/installation-methods/whm-cpanel
title: "WHM/cPanel"
---
...
For runtime agent troubleshooting after installation, see [How to Check Logs](/installation/manage-the-releem-agent/logs).
...
Confirm that the install command used the correct API key, then review `/var/log/releem/whm-install.log` and the agent logs. For more troubleshooting steps, see [How to Check if Releem Agent is Working](/get-started/troubleshoot-releem-agent).
