...
Create the monitoring account from [MySQL permissions](/supported-databases/mysql/required-permissions). Install Docker Compose and make sure the Agent container can reach MySQL.
