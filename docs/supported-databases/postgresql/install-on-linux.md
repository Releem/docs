---
id: install-on-linux
slug: /supported-databases/postgresql/install-on-linux
title: "PostgreSQL"
---
...
1. Run the Releem Agent installation command as a root user on the server:
  ...
  **Parameters:**
  ...
  For a full list of configuration settings, please refer to the [Releem Agent Configuration](/installation/manage-the-releem-agent/configuration).
