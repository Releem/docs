...
slug: /recommendations/query-optimization/automatic-schema-changes
...
If these checks fail, Releem does not apply the change automatically. See [Schema Change Troubleshooting](/recommendations/query-optimization/schema-change-troubleshooting) for the next steps.
...
- [SQL Query Optimization](/recommendations/query-optimization/enable) enabled for the server;
...
After the task starts, Releem shows the result in the dashboard. If the task fails, open the failed task and use [Schema Change Troubleshooting](/recommendations/query-optimization/schema-change-troubleshooting).
